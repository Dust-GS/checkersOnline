...
export const getDoYouHaveTooManyRooms = state => state.users.doYouHaveTooManyRooms
export const getUserNameById = (state, userId) => state.users.users.find(el => el._id === userId)