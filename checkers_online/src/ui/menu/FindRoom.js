...
import { getAllRooms, getGotRoomsFromDataBase } from '../../ducks/rooms/selectors';
...
const FindRoom = ({
  ...
  //w all rooms nie ma mojego pokokju
  allRooms,
  areAllUsersInStore,
  ...
  return (
    <div className='all-rooms-box'>
      ...
      <div className='all-rooms'>
        {allRooms.map(room =>
          <RoomOption key={room._id} roomName={room.roomName} ownerId={room.ownerId} roomId={room._id}/>
        )}
      </div>
    </div>
  )
